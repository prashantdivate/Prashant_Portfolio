      ...
      <section id="about" className="s-about target-section">
        <div className="row">
          <div className="column large-3 tab-12">
            <img className="s-about__pic" src="images/avatars/Prashant.jpg" alt="" />
          </div>
          <div className="column large-9 tab-12 s-about__content">
            <h3>About Me</h3>
            <p>
              <h3>Work for passion.</h3>
              <h3>design products for clients.</h3>
              <h3>Live for family.</h3>
            </p>
            <hr />
            <div className="row s-about__content-bottom">
              <div className="column w-1000-stack">
                ...
                <p>
                  ...
                  Pune, Maharashtra <br />
                  India <br />
                  <a href="Mob:+7028193787">+197 543 2345</a> <br />
                  <a href="mailto:#0">diwateprashant44@gmail.com</a>
                </p>
              </div>
              <div className="column w-1000-stack">
